            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <div class="p-2">
                                <form class="form-horizontal" action="index">
                                    ...
                                    <div class="mt-4 text-center">
                                        <a href="pages-recoverpw" class="text-muted"><i class="mdi mdi-lock mr-1"></i> Mot de passe oublié?</a>
                                    </div>
                                </form> 
                            </div>
                    ...
                    <div class="mt-5 text-center">
                        <p>Vous n avez pas de compte? <a href="pages-register" class="font-weight-medium text-primary"> s inscrire </a> </p>
                        <p>© المندوبية الجهوية للتربية بنابل</i></p>
                    </div>
